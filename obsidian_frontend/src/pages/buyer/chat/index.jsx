...
function Index(messagePayload) {
  ...
  useEffect(() => {
    if (messagePayload.messagePayload.message === '') {
      ...
      setMessage(`
    Name: ${messagePayload.messagePayload.name},
    Phone: ${messagePayload.messagePayload.phone_number},
    Email: ${messagePayload.messagePayload.email},
    Message: ${messagePayload.messagePayload.message}.
    `)
    }
      ...
      <div className="chat-header">
        <div className="header-left">
          ...
          <div className="user-details">
            ...
            {
              propertyData.setPropertyData?.is_seller == true ? <span>{propertyData.seller_details?.agency_name}</span> : <span>Buyer</span>
            }
          </div>
        </div>
      </div>
